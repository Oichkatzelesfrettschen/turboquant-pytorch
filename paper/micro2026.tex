...
(30 proof groups, 55 statements Z3-proven). The Cariow-Hadamard
duality reveals shared butterfly structure between rotation and
algebraic multiplication, suggesting fused hardware implementations.
Our optimized pipeline achieves 0.961 average key cosine on
Qwen2.5-3B at 3-bit with $1.81\times$ compact KV storage reduction,
compresses at 43K~vectors/sec on RTX~4070~Ti, and produces coherent
autoregressive generation from compressed caches.
